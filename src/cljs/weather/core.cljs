(ns weather.core
  (:require [reagent.core :as r]
            ...
            [weather.ajax :refer [load-interceptors!]]
            [weather.events]
            [weather.subs]
            [weather.views :as views])
  ...
  [:nav.navbar.navbar-dark.bg-primary.navbar-expand-md
   ...
   [:div#collapsing-navbar.collapse.navbar-collapse
    [:ul.nav.navbar-nav.mr-auto
     ...
     [nav-link "#/luminus" "Luminus Info" :luminus]]]])
...
(secretary/defroute "/luminus" []
  (rf/dispatch [:set-active-page :luminus]))
